<?php 
        ...
        $client_message .= 'Investment: '.$investment."\r\n";
        ...
        if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
            ...
            if($response_data->success) {
                ...
                $recipients = get_field('territory_franchise_landing_form_recipients', 'option');

                $territory_franchise_landing_form_subject_text_group = get_field('territory_franchise_landing_form_subject_text_group', 'option');
                $territory_franchise_landing_form_subject_text_in_english = $territory_franchise_landing_form_subject_text_group['territory_franchise_landing_form_subject_text_in_english'];
                $territory_franchise_landing_form_subject_text_in_french = $territory_franchise_landing_form_subject_text_group['territory_franchise_landing_form_subject_text_in_french'];

                $subject = (pll_current_language('slug') == 'fr') ? $territory_franchise_landing_form_subject_text_in_french : $territory_franchise_landing_form_subject_text_in_english;

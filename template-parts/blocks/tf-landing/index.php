<?php
    $territory_franchise_landing_title = get_field('territory_franchise_landing_title');
    $territory_franchise_landing_image = get_field('territory_franchise_landing_image');
    $territory_franchise_landing_description = get_field('territory_franchise_landing_description');
    $territory_franchise_landing_form_title = get_field('territory_franchise_landing_form_title');
    $territory_franchise_landing_desclaimer_text = get_field('territory_franchise_landing_desclaimer_text');
    global $post;
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 single-industries-section-container__grid-col">
                <?php
                    if($territory_franchise_landing_title):
                        ?>
                            <h1 class="single-industries-section-container__title primary-text-color mt-0"><?php echo $territory_franchise_landing_title; ?></h1>
                        <?php
                    endif;
                ?>
                <?php
                    if($territory_franchise_landing_image):
                        ?>
                            <img src="<?php echo $territory_franchise_landing_image['url']; ?>" alt="<?php echo $territory_franchise_landing_image['alt']; ?>" class="uf-landing-container__img mb-3">
                        <?php
                    endif;
                ?>
                <?php
                    if($territory_franchise_landing_description):
                        echo $territory_franchise_landing_description;
                    endif;
                ?>
            </div>
            <div class="col-12 col-lg-6 single-industries-section-container__grid-col-two">
                <?php
                    if($territory_franchise_landing_form_title):
                        ?>
                            <p class="single-industries-section-container__desc text-center mb-0"><?php echo $territory_franchise_landing_form_title; ?></p>     
                        <?php
                    endif;
                ?>
                <form class="single-industries-section-container__form p-4 needs-validation" method="POST" action="<?php echo get_template_directory_uri(); ?>/inc/forms/tf-landing.php" id="uf-landing" novalidate>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <?php
                            if( have_rows('territory_franchise_landing_investment_ranges') ):
                                ?>
                                    <div class="col-12 mb-3 connect_with_us_container__input-container">
                                        <label class="connect-with-us-container__label" for="investment"><?php echo pll__('Investment Level'); ?></label>
                                        <select class="form-control connect-with-us-container__input uf-landing-container__select" name="investment" id="investment" required>
                                            <option selected="" disabled="" value=""><?php echo pll__('Use dropdown for all investment ranges'); ?></option>
                                            <?php
                                                while( have_rows('territory_franchise_landing_investment_ranges') ) : the_row();
                                                    $territory_franchise_landing_investment = get_sub_field('territory_franchise_landing_investment');
                                                    ?>
                                                        <option value="<?php echo $territory_franchise_landing_investment; ?>"><?php echo $territory_franchise_landing_investment; ?></option>
                                                    <?php
                                                endwhile;
                                            ?>
                                        </select>
                    ...
                    <?php
                        if($territory_franchise_landing_desclaimer_text):
                            echo $territory_franchise_landing_desclaimer_text;
                        endif;
                    ?>
                </form>
            </div>
